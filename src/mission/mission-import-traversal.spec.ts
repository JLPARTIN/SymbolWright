...
const mission = {
  ...
  name: 'Import', objective: 'Validate', status: 'ACTIVE',
...
describe('mission import structural safety', () => {
  it('rejects events that could not be represented as structured mission evidence', () => {
    expect(() => parseMissionExportBundle({
      kind: 'codemind.mission.bundle', schemaVersion: 1,
      exportedAt: '2026-07-20T00:00:00.000Z', mission,
      events: [{ eventId: '../escape', missionId: mission.id, type: 1, timestamp: 'now', summary: 'x' }], warnings: [],
