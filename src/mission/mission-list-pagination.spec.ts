...
function mission(id: string, updatedAt: string): CodeMindMission {
  return {
    schemaVersion: 1, revision: 1, id, name: id, objective: 'List', status: 'ACTIVE',
    createdAt: updatedAt, updatedAt, lastOpenedAt: updatedAt,
...
describe('mission list pagination', () => {
  ...
  it('orders by recent activity and applies offset/limit', () => {
    ...
    store.createMission(mission('mission_11111111-1111-4111-8111-111111111111', '2026-07-20T00:00:00.000Z'))
    store.createMission(mission('mission_22222222-2222-4222-8222-222222222222', '2026-07-21T00:00:00.000Z'))
