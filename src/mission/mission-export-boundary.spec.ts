...
const mission: SymbolWrightMission = {
  ...
  workspace: {
    kind: 'repository',
    openFiles: [{ path: 'a.txt', openedAt: '2026-07-20T00:00:00.000Z', contentHash: 'hash' }],
  ...
  references: {
    ...
    checkpointLinks: [
      { checkpointId: 'checkpoint-1', createdAt: '2026-07-20T00:00:00.000Z', paths: ['a.txt'] },
    ],
    memoryEntryIds: [],
    memoryLinks: [],
    commitShas: [],
