...
export type CodemindPermissionDisposition =
  (typeof CODEMIND_PERMISSION_DISPOSITIONS)[number];

export const CODEMIND_RISK_LEVELS = [
  'LOW',
  'MEDIUM',
  'HIGH',
  'CRITICAL',
...
export type CodemindProtectedPathClass =
  (typeof CODEMIND_PROTECTED_PATH_CLASSES)[number];
