export const CODEMIND_PROOF_REPORT_RENDERER_BLOCK_ID =
  'CODEMIND-PROOF-HARNESS-08' as const;
...
export const CODEMIND_PROOF_RENDER_FORMATS = [
  'plain',
  'markdown',
  'compact',
] as const;
export type CodemindProofRenderFormat =
  (typeof CODEMIND_PROOF_RENDER_FORMATS)[number];
