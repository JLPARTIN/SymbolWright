 ...
 */
export function readPolicyVersion(value: string | undefined, fallback: number): PolicyVersionRead {
  ...
  return Number.isSafeInteger(parsed) ? { valid: true, value: parsed } : { valid: false, value: 0 }
}
