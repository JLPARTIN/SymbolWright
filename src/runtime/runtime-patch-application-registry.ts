...
import { createLocalWriteRuntimeContext, createLocalWriteRuntimeRegistry } from './runtime-local-write-registry.js'
...
export function createPatchApplicationRuntimeContext(cwd: string = process.cwd()): RuntimeToolContext {
