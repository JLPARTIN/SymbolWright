...
import type { AjnaRuleEvaluationReport, AjnaRuleEvaluationResult } from './ajna-rule-types.js'
...
function renderOverride(override: AjnaGovernanceOverrideRecord): AjnaRenderedGovernanceOverride {
  const base = {
    id: override.id,
