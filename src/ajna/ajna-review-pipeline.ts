...
export function runAjnaReviewPipeline(input: AjnaReviewPipelineInput): AjnaReviewPipelineReport {
  ...
  const riskInput: Parameters<typeof synthesizeAjnaRisk>[0] = {
    ...
    ...(input.blockingFindings !== undefined || blockingRules.length > 0
      ...
      : {}),
    ...(input.repoImpactLevel !== undefined ? { repoImpactLevel: input.repoImpactLevel } : {}),
