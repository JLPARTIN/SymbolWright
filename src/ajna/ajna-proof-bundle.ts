export const AJNA_PROOF_BUNDLE_BLOCK_ID = 'CODEMIND-AJNA-REVIEW-02' as const;
export const AJNA_PROOF_BUNDLE_PR_ID = 'PR-CM-AJNA-02' as const;
export const AJNA_PROOF_BUNDLE_PHASE_ID = 'CODEMIND-AJNA-02' as const;
