...
export const AGENT_KERNEL_MEMORY_SCOPES = [
  'isolated',
  'shared-read-only',
  'export-only',
] as const;
...
export const AGENT_KERNEL_SKILL_RISK_CLASSES = [
  'LOW',
  'MEDIUM',
  'HIGH',
  'CRITICAL',
] as const;
export type AgentKernelSkillRiskClass =
  (typeof AGENT_KERNEL_SKILL_RISK_CLASSES)[number];
