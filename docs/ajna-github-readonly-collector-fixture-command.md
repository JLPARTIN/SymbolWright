...
The `symbolwright ajna github-readonly-collector-fixture <json-file>` command reads a local collector request fixture and renders the collected snapshot JSON through an injected fake read-only collector port.
...
```bash
symbolwright ajna github-readonly-collector-fixture examples/ajna/github-readonly-collector-request.ready.json
```
